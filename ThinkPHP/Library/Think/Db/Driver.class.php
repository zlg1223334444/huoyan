...
//
//        try {
//            $res=$this->_linkID->getAttribute(PDO::ATTR_CONNECTION_STATUS);
//            //var_dump($res);        
//            $re = $this->_linkID->getAttribute(PDO::ATTR_SERVER_INFO);
//            //var_dump($re);
//            if (!$re || strpos($re,"MySQL server has gone away")>=0 || strpos($re,"Lost connection to MySQL server")>=0) {
//                unset($this->linkID[0]);
//                $this->_linkID = $this->connect();
//            }
//        } catch (\PDOException $e) {
//            $re=$e->getMessage();
//            //var_dump($re);
//            if(strpos($re,"MySQL server has gone away")>=0 || strpos($re,"Lost connection to MySQL server")>=0){
//                unset($this->linkID[0]);
//                $this->_linkID = $this->connect();
//            }
//        }
