...
function U($url='',$vars='',$suffix=true,$domain=false) {
    ...
    //自定义保留URL中的参数ZK
    if(!empty(C("paramskeep"))&&is_array(C("paramskeep"))){
        $arr_paramskeep=C("paramskeep");
        $params=Array();
        foreach($arr_paramskeep as $k_paramskeep=>$v_paramskeep){
            if(isset($_GET[$k_paramskeep])||isset($_POST[$k_paramskeep])){
                $params[$k_paramskeep]=  empty($v_paramskeep)?$_GET[$k_paramskeep]:$v_paramskeep;
            }
        }
        $vars = array_merge($params,$vars);
    }
